...
namespace EGHeals.Application.Features.TeamWorkMembers.Commands.UpdateTeamWorkMember
{
    public record UpdateTeamWorkMemberCommand(UpdateTeamWorkMemberDto TeamworkMember) : ICommand<UpdateTeamWorkMemberResult>;
    public record UpdateTeamWorkMemberResult(bool IsSuccess);

    public class UpdateTeamWorkMemberCommandValidator : AbstractValidator<UpdateTeamWorkMemberCommand>
    {
        public UpdateTeamWorkMemberCommandValidator()
        {
            RuleFor(x => x.TeamworkMember).NotNull().WithMessage("Error")
                                          .SetValidator(new UpdateTeamWorkMemberDtoValidator());
        }
    }

    public class UpdateTeamWorkMemberDtoValidator : AbstractValidator<UpdateTeamWorkMemberDto>
    {
        public UpdateTeamWorkMemberDtoValidator()
        {
